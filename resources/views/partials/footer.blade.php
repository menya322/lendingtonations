 <!-- Footer Start -->
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <p class="text-white mb-0">Masindi Uganda</p>
                            </div>
                            <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <p class="text-white mb-0">www.lendingtonations.org</p>
                            </div>
                            <div class="d-flex">
    ...
    <div class="container">
        <!-- Changed 'justify-content-center' to center the row content -->
        <div class="row g-4 align-items-center justify-content-center">
            <!-- Changed 'col-md-6' to 'col-md-12' and forced 'text-center' -->
