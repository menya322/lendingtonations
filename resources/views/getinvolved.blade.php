            ...
            <div class="container py-5">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="testimonial-card bg-white rounded p-4">
                            <div class="d-flex align-items-center mb-3">
                                <img src="{{asset('assets/images/ltn14.jpg')}}" class="rounded-circle me-3" style="width: 60px; height: 60px;" alt="Testimonial">
                                <div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="testimonial-card bg-white rounded p-4">
                            <div class="d-flex align-items-center mb-3">
                                <img src="{{asset('assets/images/ltn13.jpg')}}" class="rounded-circle me-3" style="width: 60px; height: 60px;" alt="Testimonial">
                                <div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="testimonial-card bg-white rounded p-4">
                            <div class="d-flex align-items-center mb-3">
                                <img src="{{asset('assets/images/ltn15.jpg')}}" class="rounded-circle me-3" style="width: 60px; height: 60px;" alt="Testimonial">
                                <div>
